...
const InstructorProfilePage = async ({ params }) => {
          ...
          <div className='bg-white rounded-2xl p-6 shadow'>
            <div className='mb-6'>
              <div className='w-36 h-36 rounded-full  mb-5 mx-auto overflow-hidden'>
                <Image
                  src='https://images.pexels.com/photos/7849511/pexels-photo-7849511.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
                  alt=''
